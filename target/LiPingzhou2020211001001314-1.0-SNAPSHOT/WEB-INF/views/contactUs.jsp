...
<script type="text/javascript" src="http://api.map.baidu.com/api?key=&v=1.1&services=true"></script>
    ...
    function createMap(){
        ...
        var point = new BMap.Point(115.876018,28.749703);//定义一个中心点坐标
    ...
    //鏍囨敞鐐规暟缁?
    var markerArr = [{title:"华东交通大学",content:"位置：<br/>青山湖区双港东大街808号<br/>(0791)87046576",point:"115.873619|28.750131",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //添加标记marker
    function addMarker(){
